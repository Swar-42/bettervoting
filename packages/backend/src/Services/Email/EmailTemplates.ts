    ...
    return {
        ...
        html: emailTemplate(`
          <div> 
            ...
            ${election.settings.ballot_updates ? `<p>If the election is still open, you can <a clicktracking="off" href="${url}/${election.election_id}/id/${ballot.user_id}">change your vote</p>.` : ''}
          </div>    
        `),
    }
}
